...
#Find Directory of script currently executed
START_DIR=$(pwd)
LOC_DIR_SCRIPT=$(dirname "$0")
SCRIPT_DIR="${START_DIR}/${LOC_DIR_SCRIPT}"
echo "Current Bash Script is in: $SCRIPT_DIR"
...
#revert back to original direcotry 
cd ${START_DIR}
